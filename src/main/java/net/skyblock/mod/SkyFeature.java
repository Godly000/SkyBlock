...
public class SkyFeature extends Feature<SkyGenConfig> {
    public SkyFeature(Codec<SkyGenConfig> configCodec) {
        super(configCodec);
    }

    @Override
    public boolean generate(FeatureContext<SkyGenConfig> context) {
        BlockPos pos = context.getOrigin();
        SkyGenConfig config = context.getConfig();
